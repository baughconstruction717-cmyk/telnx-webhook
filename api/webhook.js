...
export default function handler(req, res) {
          ...
          commands: [
            {
              ...
              params: {
                ...
                from: "+1YOURTELNYXNUMBER"   // <-- replace with your Telnyx DID
              }
            }
          ]
        });
  ...
  res
    .status(200)
    .json({ message: "Hello from Telnyx Webhook" });
}
          ...
          commands: [
            {
              type: "dial",
              params: {
                to: "+17177362829", // your real phone number
                from: event.data.payload.from // preserve caller ID
              }
            }
          ]
        });
